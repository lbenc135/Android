...
public class Tile {
	...
	public Tile(int x, int y, int typeInt) {
		...
		if (type == 5) {
			tilePixmap = Assets.tiledirt;
		} else if (type == 8) {
			tilePixmap = Assets.tilegrassTop;
		} else if (type == 4) {
			tilePixmap = Assets.tilegrassLeft;

		} else if (type == 6) {
			tilePixmap = Assets.tilegrassRight;

		} else if (type == 2) {
			tilePixmap = Assets.tilegrassBot;
		} else {
			type = 0;
		}
	...
	public Pixmap getTilePixmap() {
		return tilePixmap;
	}

	public void setTilePixmap(Pixmap tilePixmap) {
		this.tilePixmap = tilePixmap;
	}
